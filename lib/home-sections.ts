// Shared by the homepage and scripts/build-home-snapshot.ts so the snapshot
// generator and the renderer can never drift apart.

export type Section = { name: string; slug: string; title?: string };

export const STYLE_SECTIONS: Section[] = [
  // Flagship
...
export const GENRE_SECTIONS: Section[] = [
