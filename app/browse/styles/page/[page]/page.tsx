...
export async function generateMetadata({
  ...
  if (n === null) notFound();
  return getBrowseIndexMetadata("styles", n);
}

export default async function StylesPaginatedPage({
  params,
}: {
  params: Promise<{ page: string }>;
}) {
  ...
  const n = parsePage(page);
  if (n === null) notFound();
  if (n === 1) permanentRedirect("/browse/styles");

  return <BrowseIndexContent kind="styles" page={n} />;
}
